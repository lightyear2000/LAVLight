...
#define LAVF_REGISTRY_KEY L"Software\\LAVLight\\Splitter"
#define LAVF_REGISTRY_KEY_FORMATS LAVF_REGISTRY_KEY L"\\Formats"
#define LAVF_LOG_FILE     L"LAVLightSplitter.txt"
...
class __declspec(uuid("F537709F-FA7C-4B3B-90A0-2C7E9EB7A189")) CLAVSplitter
  : public CBaseFilter
  , public CCritSec
  , protected CAMThread
...
class __declspec(uuid("40AF840F-0DE2-462B-B00E-681D86B21159")) CLAVSplitterSource : public CLAVSplitter
{
public:
